...
class DB {
	...
	public static function connectWriteDB() {
		if(self::$writeDBConnection === null) {
			// first para databasetype:hostname:databasname / 2nd para username / 3th para password 
			    self::$writeDBConnection = new PDO('mysql:host=localhost;dbname=sms;charset=utf8', 'root', '');
	...
	public static function connectReadDB() {
		if(self::$readDBConnection === null) {
				self::$readDBConnection = new PDO('mysql:host=localhost;dbname=sms;charset=utf8', 'root', '');
